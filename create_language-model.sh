...
ngram-count -text language_models/input/$1.out -order 2 -lm language_models/corpus.lm -addsmooth 0

language_models/mkbingram -nrl language_models/corpus.lm language_models/corpus.bin
